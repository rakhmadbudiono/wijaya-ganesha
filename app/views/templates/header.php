...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="<?= BASEURL; ?>/articles" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            Articles
            </a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="<?= BASEURL; ?>/motivation">Ceritaku Masuk ITB</a>
            <a class="dropdown-item" href="<?= BASEURL; ?>/tech-for-mojokerto">Technology for Mojokerto</a>
            <a class="dropdown-item" href="<?= BASEURL; ?>/peduli-mojokerto">Peduli Mojokerto</a>
            </div>
        </li>
        <li class="nav-item">
